...
mobility['region1'].fillna("No Selection", inplace=True)
sub_region1 = mobility['region1'].unique()
mobility['region2'].fillna("No Selection", inplace=True)
...
def update_value(sregion2, sregion1, scountry, location):
    ...
    x = df.index
    if sregion2 != 'No Selection':
        y = df[df['region2']==sregion2][location]
    elif sregion2 != 'No Selection' and sregion2 == 'No Selection':
